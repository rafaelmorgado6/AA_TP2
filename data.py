...
plt.title("Distribuição de Temas - Notícias Falsas")
plt.tight_layout()
plt.show()
...
plt.title("Distribuição de Temas - Notícias Verdadeiras")
plt.tight_layout()
plt.show()

# Gráfico de barras por mês
monthly_counts_by_label.plot(kind='bar', figsize=(14, 6))
plt.title('Número de Notícias Falsas e Verdadeiras por Mês')
plt.xlabel('Mês')
